...
// Form submission for updating an order
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if (mysqli_num_rows($order_result) == 1) {
        ...
        $items_sql = "SELECT oi.*, 
                        ...
                        CONCAT('../public/', p.image) AS image
                        FROM order_items oi 
    ...
    <div class="row mb-3">
        <div class="col-lg-8">
            <div class="admin-card">
                ...
                <p class="mb-3"><strong>Date:</strong> <?php echo date('j F Y, g:i a', strtotime($order['order_date'])); ?></p>
