                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="categories.php" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                                    ...
                                                    <button type="submit" name="delete_category" class="btn-delete btn-sm">
        ...
        <div class="modal-content">
            <form method="post" action="categories.php" id="categoryForm">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="add_category" id="saveCategoryBtn" class="btn-admin">Add Category</button>
                </div>
            </form>
        </div>
    </div>
